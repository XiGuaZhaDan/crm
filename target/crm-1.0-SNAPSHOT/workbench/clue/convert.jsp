...
<script type="text/javascript">
	$(function(){
		...
		//为搜索市场活动模态窗口中 搜索框 绑定事件，通过触发回车键，查询并展示市场活动信息列表
		...
		$("#submitBtn").click(function (){
			...
			//将取得的名字和id分别添加到 市场活动源信息框 和 隐藏域中
			$("#activityId").val(id);
...
<body>
	...
	<div id="operation" style="position: relative; left: 40px; height: 35px; top: 100px;">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="javascript:void(0);" onclick="window.history.back();"><input class="btn btn-default" type="button" value="取消"></a>
	</div>
</body>
</html>